function super_rectangleObject(inputData = {}){
// JSON Recieving ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// Sub Shapes ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	subShapeList.add(new rectangleObject({ "initialData":{'origin':axiom,'parentAngle':angle,'position':[10,10],"anchor":[0,0],"width":100,"height":100,"angle":0.1}, "styleData":{"R":250,"G":200,"B":200}}) );
...
// Mouse Methods /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	this.drag = function(point){
		if(selected){
			...
			else{subShapeList.getObj(lastHover).drag(point);}
		}
	}
}