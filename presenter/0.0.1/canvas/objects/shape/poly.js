...
// Values ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(InitialData.hasOwnProperty('Selected')){ var Selected = InitialData.Selected; }else{ var Selected = false; }
...
this.displayPoints = function(){return Points;}
this.displayPoint = function(PointNumber){return Points[PointNumber];}
this.addPoint = function(NewPoint){Points.push(NewPoint);}
this.setPoint = function(PointNumber,NewPoint){if(PointNumber > Points.length){console.error("Poly.setPoint - PointNumber unreachable"); return;} Points[PointNumber] = NewPoint;}
this.removePoint = function(PointNumber){if(NewPoint > Points.length){console.error("Poly.removePoint - PointNumber unreachable"); return;}Points = Points.splice(PointNumber,1);}
this.replacePoints = function(NewPoints){Points = NewPoints;}
this.shiftPoint = function(PointNumber,shiftX,shiftY){
	if(PointNumber > Points.length){console.error("Poly.setPoint - PointNumber unreachable"); return;}
	Points[PointNumber] = [Points[PointNumber][0]+shiftX,Points[PointNumber][1]+shiftY]
}
...
// Mouse Methods //
	this.select = function(){
		if(!Selected){ this.set("A",this.getColour()[3]/2); }
		Selected = true;
	}
	...
	this.drag = function(x,y){ 
		if(Selected){ 
			for(var a = 0; a < Points.length; a++){this.shiftPoint(a,x,y);} 
		} 
	}
}
// // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // 
