...
var StartingAngle = 0; var SpinAmount = 3;
	function MouseSpin(data, object){
		...
		StartPosition = [(data.clientX/ViewportElement.width),(data.clientY/ViewportElement.height)];
		StartingAngle = View.Angle;
	}

	function MouseSpin_Calculate(data){
		EndPosition = [(data.clientX/ViewportElement.width),(data.clientY/ViewportElement.height)];
...
// Zoom //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function MouseZoom(data, object){
		...
		Zoom_WithViewportPosition(NewZoomIndex,data.clientX/ViewportElement.width,data.clientY/ViewportElement.height);
	}	
