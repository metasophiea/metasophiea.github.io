...
//	DrawList.Background.push( new poly({ "ID":GetNextID("background"), "InitialData":{"Points":[[-5000,0], [-5000,10], [5000,10], [5000,0]]} }) );
	//DrawList.Background.push( new image({"ID":GetNextID("background"), "InitialData":{"Center":[100,100],"Width":100,"Height":200,"Angle":Math.PI/4}, "StyleData":{"URL":"https://cdn.earthporm.com/wp-content/uploads/2014/08/amazing-trees-17.jpg"} }) );	

	stemp = GetNextID("background");
	DrawList.Background.push( new image2({"ID":stemp, "InitialData":{"Position":[200,200],"Anchor":[0,0],"Width":100,"Height":200,"Angle":Math.PI/5}, "StyleData":{"URL":"https://cdn.earthporm.com/wp-content/uploads/2014/08/amazing-trees-17.jpg"} }) );	
