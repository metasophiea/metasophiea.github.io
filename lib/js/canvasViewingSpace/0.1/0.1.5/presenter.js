//Included Files
	var presenterRepositoryURL = 'http://metasophiea.com/lib/js/canvasViewingSpace/0.1/0.1.5/';
	var includeFiles = {
		'CSS':[],
		'JS':[
			[	'http://metasophiea.com/lib/js/math/geometry/0.0.0/geometry.js',
				'http://metasophiea.com/lib/js/math/curve/0.0.0/curve.js',
...
//get, getJS.js script, and then load the files with it
	...
	temp.src = 'http://metasophiea.com/lib/js/getJS/2.1.1/getJS.js';
