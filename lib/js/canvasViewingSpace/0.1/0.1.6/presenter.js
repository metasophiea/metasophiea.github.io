//Included Files
	var presenterRepositoryURL ='https://metasophiea.com/lib/js/canvasViewingSpace/0.1/0.1.6/';
	var includeFiles = {
		'CSS':[
		...
		'JS':[
			[	
				'https://metasophiea.com/lib/js/math/geometry/0.0.0/geometry.js',
				'https://metasophiea.com/lib/js/math/curve/0.0.0/curve.js',
				'https://metasophiea.com/lib/js/io/loadsave/1.0.0/loadsave.js',
...
//get getJS.js script, and then load the files with it
	...
	temp.src = 'https://metasophiea.com/lib/js/getJS/2.1.1/getJS.js';
	temp.setAttribute('onLoad','getJS.get(includeFiles.JS);');
	document.head.appendChild(temp);	

//get getCSS.js script, and then load the files with it
	var temp = document.createElement('script');
	temp.type = 'text/javascript'; 
	temp.src = 'https://metasophiea.com/lib/js/liveEdit/getCSS.js';
