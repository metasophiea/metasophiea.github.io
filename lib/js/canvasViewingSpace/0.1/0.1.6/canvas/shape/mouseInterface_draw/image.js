function mouseInterface_drawImage(event){
	...
	viewportElement.setAttributeNS(null,"onmousemove","mouseInterface_drawImage_drag(["+[event.layerX,event.layerY]+"],event);");
	viewportElement.setAttributeNS(null,"onmouseout","mouseInterface_drawImage_finish();setupMouseInterface();");
	viewportElement.setAttributeNS(null,"onmouseup","mouseInterface_drawImage_finish();setupMouseInterface();");
}

function mouseInterface_drawImage_drag(originPoint,event){
...
function mouseInterface_drawImage_finish(){
	...
	drawList.foreground.add( new superShape_adjustableImage({ "initialData":data.initialData, "styleData":data.styleData }) );	
