...
// Draw //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	this.draw = function(){
		...
		if(Math.abs(count[0]) == 4 || Math.abs(count[1]) == 4){}
			...
			else{basicShape_image(viewport,dimention[0],dimention[1],realPosition,anchor,calculated.angle,'http://metasophiea.com/lib/image/canvasViewingSpace/noimageimage.png');}
