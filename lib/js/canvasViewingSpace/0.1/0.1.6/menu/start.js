function startMenu(type,point,ID=-1,data={}){
	var newWindow;
	switch(type){
		...
		case 'automoveScriptElementEditor': if(!doesWindowExist(type)){newWindow = menu_automoveScriptElementEditor(point,data);} break;				
	}
...
function removeAllWindows(){
	...
	for(var a = SVGs.length-1; a >= 0; a--){
		SVGs[a].parentElement.removeChild(SVGs[a]);
	}
...
// Graphics //// //// //// //// //// //// //// //// //// ////
	...
	// Text //// //// //// ////
		...
		//Body
			...
			SVG_Element.appendChild(buildMenu_text("generalText",['70',temp],'X:',"start","12","Lucida Console"));
	...
	// Text Box //// //// //// ////
		...
		var temp = 31;
		SVG_Element.appendChild( buildMenu_textBox("noCSSText",['85',temp],"30","10",data.initialData.position[0],12,"Lucida Console",ID+"-position_x",updateCode_Numerical) );
		SVG_Element.appendChild( buildMenu_textBox("noCSSText",['135',temp],"30","10",data.initialData.position[1],12,"Lucida Console",ID+"-position_y",updateCode_Numerical) );temp+=15;
	...
	// Text Box //// //// //// ////
		var updateCode_Text = ''+
			...
			'else{'+
				...
				'this.childNodes[0].value = temp;'+
			'}'+
			'this.childNodes[0].scrollTop = 2;'+
		'';
		SVG_Element.appendChild( buildMenu_textBox("headerText",[20,5],376,17,"Scene 1",18,"Lucida Console",'title',updateCode_Text) );
