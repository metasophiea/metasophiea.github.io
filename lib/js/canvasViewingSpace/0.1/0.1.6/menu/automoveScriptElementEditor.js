...
// Graphics //// //// //// //// //// //// //// //// //// ////
	//SVG Container
  	...
  	// Plates //// //// //// ////
        ...
        //Header Bar
			...
			shape.setAttribute("onmousedown",code);
			SVG_Element.appendChild(shape);
			SVG_Element.appendChild(buildMenu_text("generalText",['25','18'],'Element Editor',"start",'16',"Lucida Console"));
    ...
    //Options
        //Position
	    	...
	    	SVG_Element.appendChild(buildMenu_textBox("noCSSText",[87,33],"30","12",data.position.position[0],12,"Lucida Console","automoveScriptElementEditor-position_x") );
 	    	SVG_Element.appendChild(buildMenu_text("generalText",[120,45],'Y: ',"start","12","Lucida Console"));           
   	    	SVG_Element.appendChild(buildMenu_textBox("noCSSText",[135,33],"30","12",data.position.position[1],12,"Lucida Console","automoveScriptElementEditor-position_y") );       
        //Angle
	    	SVG_Element.appendChild(buildMenu_text("generalText",[10,60],'Angle: ',"start","12","Lucida Console"));
	    	SVG_Element.appendChild(buildMenu_textBox("noCSSText",[55,48],"30","12",data.position.angle,12,"Lucida Console","automoveScriptElementEditor-position_angle") );
        //Zoom
	    	SVG_Element.appendChild(buildMenu_text("generalText",[90,60],'Zoom: ',"start","12","Lucida Console"));
	    	SVG_Element.appendChild(buildMenu_textBox("noCSSText",[130,48],"30","12",data.position.angle,12,"Lucida Console","automoveScriptElementEditor-position_zoom") );   

	if(number != 0){
        //Duration
	    	SVG_Element.appendChild(buildMenu_text("generalText",[10,75],'Duration: ',"start",12,"Lucida Console"));
	    	SVG_Element.appendChild(buildMenu_textBox("noCSSText",[75,63],"30","12",data.details.duration,12,"Lucida Console","automoveScriptElementEditor-details_duration") );  
        //Type                 
	    	SVG_Element.appendChild(buildMenu_text("generalText",[110,75],'Type: ',"start",12,"Lucida Console"));
	    	SVG_Element.appendChild(buildMenu_textBox("noCSSText",[150,63],"30","12",data.details.type,12,"Lucida Console","automoveScriptElementEditor-details_type") );            
	}
