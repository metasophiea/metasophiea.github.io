...
// Graphics //// //// //// //// //// //// //// //// //// ////
	...
	// Text //// //// //// ////
		...
		//Selected element readout	
			...
			SVG_Element.appendChild(buildMenu_text("generalText",[70,90],'- Destination -',"start",'12',"Lucida Console"));				
			SVG_Element.appendChild(buildMenu_text("generalText",[80,106],'Position: X: n/a Y: n/a',"start",'12',"Lucida Console",'menu_automoveScriptEditor_scriptelementReadout_1'));
			SVG_Element.appendChild(buildMenu_text("generalText",[80,122],'Zoom: n/a | Angle: n/a',"start",'12',"Lucida Console",'menu_automoveScriptEditor_scriptelementReadout_2'));
			SVG_Element.appendChild(buildMenu_text("generalText",[70,138],'- Transition -',"start",'12',"Lucida Console"));				
			SVG_Element.appendChild(buildMenu_text("generalText",[80,154],'Duration: n/a | Type: n/a',"start",'12',"Lucida Console",'menu_automoveScriptEditor_scriptelementReadout_3'));
