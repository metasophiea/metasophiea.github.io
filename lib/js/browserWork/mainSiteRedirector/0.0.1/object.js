var siteRedirector = new function(){
    ...
    this.redirect = function(data,element){
        browserData = data;
		iframe_element = element; URL_start = 'https://metasophiea.com/mainSite/display/'+data.system+'/'+data.browser+'/';
    ...
    this.getData = function(){
			...
			if(fileData.browser == 'chromium'){fileData.browser = 'chrome';}
    ...
    function goTo(version){ 
        if(version < 0){ iframe_element.src = './mainSite/display/'+browserData.system+'/compatibility/index.html'; }
