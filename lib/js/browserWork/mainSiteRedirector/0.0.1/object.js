var siteRedirector = new function(){
    ...
    this.getData = function(){
			...
			else if(bowser.hasOwnProperty('windows')){fileData.system = 'desktop'; console.log(fileData);}
			else if(bowser.hasOwnProperty('mac')){fileData.system = 'desktop';}
			else if(bowser.hasOwnProperty('linux')){fileData.system = 'desktop';}
			else if(bowser.hasOwnProperty('edgeVersion')){fileData.system = 'desktop'; /*fileData.browser = 'microsoftEdge';*/}
