    ...
    //components
        var controller = function(registers,bitLength){
            ...
            //components
                ...
                var memory = function(registers,bitLength){
                    ...
                    //commands
                        ...
                        this.reset = function(){data = []; for(var a = 0; a < registers; a++){ data.push(0);}}
            ...
            //commands
                ...
                this.reset = function(){component_memory.reset();}
        }
        ...
        //construction
            ...
            this.reset = function(){ pointer = 0; program = []; programCounter = 0; lastProgramCounterPosition = programCounter; component_controller.reset(); 
            ...
            this.dumpMemory = function(){return component_controller.dumpMemory();}
