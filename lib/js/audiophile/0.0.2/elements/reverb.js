var reverb = function(){
	...
	var reverbeRepoURL = 'https://metasophiea.com/lib/audio/impulseResponse/';
	...
	function getReverbTypeList(callback){
		var ajaxRequest = new XMLHttpRequest();
		ajaxRequest.open('GET', 'https://metasophiea.com/lib/audio/impulseResponse/available.list', true);
		ajaxRequest.onload = function() {
