...
/*
Regular getJS
 single       - 'https://metasophiea.com/lib/js/liveEdit/getJS/2.0.1/getJS.js'
 list         - ['https://metasophiea.com/lib/js/liveEdit/getJS/2.0.1/getJS.js','https://metasophiea.com/lib/js/liveEdit/getJS/2.0.1/getJS.js']
 ordered list - [['https://metasophiea.com/lib/js/liveEdit/getJS/2.0.1/getJS.js'],['https://metasophiea.com/lib/js/liveEdit/getJS/2.0.1/getJS.js]]

getLatest getJS
 single       - {'folderAddress':'https://metasophiea.com/lib/js/liveEdit/getJS/','filename':'getJS.js'}
 list         - [{'folderAddress':'https://metasophiea.com/lib/js/liveEdit/getJS/','filename':'getJS.js'},{'folderAddress':'https://metasophiea.com/lib/js/liveEdit/getJS/','filename':'getJS.js'}]
 ordered list - [[{'folderAddress':'https://metasophiea.com/lib/js/liveEdit/getJS/','filename':'getJS.js'}],[{'folderAddress':'https://metasophiea.com/lib/js/liveEdit/getJS/','filename':'getJS.js'}]]
*/
