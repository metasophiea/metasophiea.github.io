...
//Main SVG
	var SVG_Element = document.createElementNS('https://www.w3.org/2000/svg','svg');
	...
	SVG_Element.setAttribute("xmlns","https://www.w3.org/2000/svg");
	document.getElementsByTagName("body")[0].appendChild(SVG_Element);

//Backing Shape
	var shape = document.createElementNS('https://www.w3.org/2000/svg','polygon')
...
//Image Boxes
	var def = document.createElementNS('https://www.w3.org/2000/svg','defs');	
	for(var a = 0; a < data.length; a++){
		var pattern = document.createElementNS('https://www.w3.org/2000/svg','pattern');
			pattern.id = "img_"+a;
			pattern.setAttribute("patternUnits","userSpaceOnUse");
			pattern.setAttribute("x",0); pattern.setAttribute("y",0);
			pattern.setAttribute("height",100); pattern.setAttribute("width",100); 
		var image = document.createElementNS('https://www.w3.org/2000/svg','image');
			image.setAttribute("x",0); image.setAttribute("y",0);
			image.setAttribute("height",100); image.setAttribute("width",100);
			image.setAttributeNS("https://www.w3.org/1999/xlink","xlink:href",data[a].image_url);
...
function addTabs(){
	...
	for(var a = 0; a < getData().length; a++){
		shape = document.createElementNS('https://www.w3.org/2000/svg','rect');
			shape.id = 'tab'+a;
